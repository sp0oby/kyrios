    ...
    <CardWrapper>
      ...
      <CardContent style={{color: "#2CCBFF"}}>
        ...
        >
          ...
          <Typography variant="h5">{contractBNB} METIS</Typography>
        </Grid>
        <Grid
          container
          justifyContent="space-between"
        ...
        >
          ...
          <Typography variant="h5">{walletBalance.bnb} METIS</Typography>
        </Grid>
        <Grid
          container
          justifyContent="space-between"
          ...
          mt={3}
        >
          <Typography variant="body1">Kyrios</Typography>
          <Typography variant="h5">{walletBalance.beans} KYRIOS</Typography>
        </Grid>
